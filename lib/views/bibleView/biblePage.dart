...
class BiblePage extends StatefulWidget {
  final int bookId;
  final int chapterId;
  BiblePage(this.bookId, this.chapterId);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBar(
          title: Text("$bookName第${widget.chapterId.toString()}章"),
...
////////////////////////////////
  ...
  updateData() async {
    ...
    bibles = await BibleContentTable().queryByBookAndChapter(widget.bookId, widget.chapterId);
