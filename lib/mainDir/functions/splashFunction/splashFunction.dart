...
import 'package:da_ka/mainDir/functions/splashFunction/splashStringPage.dart';
          ...
          child: ListView(children: <Widget>[
            ...
            ListTile(
              ...
              trailing: Text(
                ...
                style: TextStyle(color: splashEntity.hasSplash ? ListTileTheme.of(context).textColor : Theme.of(context).disabledColor),
              ),
            ...
            ListTile(
                title: Text("字体大小"),
                trailing: Text(
                  splashEntity.splashFontSize.toString() + "px",
                  style: TextStyle(color: splashEntity.hasSplash ? ListTileTheme.of(context).textColor : Theme.of(context).disabledColor),
                ),
                enabled: splashEntity.hasSplash,
                onTap: () {
